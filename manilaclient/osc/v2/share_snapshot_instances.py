...
class ListShareSnapshotInstance(command.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        snapshot = (
            share_client.share_snapshots.get(parsed_args.snapshot)
        ...
        return (
            list_of_keys,
            (
                utils.get_item_properties(s, list_of_keys)
                for s in share_snapshot_instances
            ),
        )
...
class SetShareSnapshotInstance(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                'Indicate state to update the snapshot instance to. '
