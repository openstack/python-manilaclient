...
class ShareGroupSnapshotManagerTest(utils.TestCase):
    ...
    def test_list(self):
        ...
        mock_list.assert_called_once_with(
            snapshots.RESOURCES_PATH + '/detail', snapshots.RESOURCES_NAME
        )
    ...
    def test_list_with_filters(self):
        ...
        self.assertEqual([fake_share_group_snapshot], result)
        expected_path = (
            snapshots.RESOURCES_PATH + '?all_tenants=1&status=ERROR'
        )
        mock_list.assert_called_once_with(
    ...
    @ddt.data(
        {'sort_key': 'name', 'sort_dir': 'invalid'},
